.PHONY: clean data checkall requirements clean-wheelbuild wheel
...
## Completely wipe all docker containers
...
## Clean up setuppy and dist for wheel
clean-wheelbuild:
	rm -rf build/
	rm -rf dist/
	rm -rf *.egg-info

## Make wheel and distributions
wheel: clean-wheelbuild
...
## Run as developer (WIP DOESN'T WORK)
devrun: venv/py3/bin/activate
